    ...
    <section id="home" className="section-padding bg-white dark:bg-dark-custom">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto px-4">
          {/* Left Content */}
          <motion.div variants={fadeIn} className="text-left order-1 lg:order-1">
            ...
            <motion.h1
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-gray-900 dark:text-white mb-4 md:mb-6 leading-tight font-bold"
            >
